...
** Intro/Objectives of the simulator
** Architettura funzionale
*** Moduli
- Classi e tipi
  "una soluzione che permetta una facile sostituzione"
- Layered Structure
- Manager di configurazione

Perché un manager
Perché una struttura a livelli (utilizzo previsto)
