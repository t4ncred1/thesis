...
2. Making such model fine-tunable and adaptable, in order to have granular control over the output of the simulator and repurpose it easily for different settings and different data sources.
