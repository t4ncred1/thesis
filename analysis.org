...
*** Conclusion
In the model whose development was shown in this section we have identified a total of 5 time intervals:
...
The next step in our analysis is to find a distribution that correctly fits each of these time intervals (except the last one).
